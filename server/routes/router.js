...
import {auth, verifyAdmin} from "../middleware/privateRoute.js";

const router = expres.Router();

// users apis
router.get("/",(req, res) => {res.send('calling home page')})
...
router.patch("/update-book/:id",auth,verifyAdmin,updateBook)
